...
import techanand.apps.stockcalculator.fragments.StocksBySharePrice;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.action_share:
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "https://goo.gl/txMvNV");
